...
HRESULT CMainApp::Ready_DefaultSetting(LPDIRECT3DDEVICE9* ppGraphicDev)
{
	...
	CAssetMgr::GetInstance()->AddAsset(L"Font_Jinji", CAssetDefaultFont::Create(L"궁서", 0, 20, FW_HEAVY));
	...
	CAssetMgr::GetInstance()->AddAsset(L"Font_Griun", CAssetDefaultFont::Create(L"../Bin/Resource/Font/Griun_PolSensibility-Rg.ttf", L"그리운 경찰감성체", 0, 20, FW_HEAVY));
