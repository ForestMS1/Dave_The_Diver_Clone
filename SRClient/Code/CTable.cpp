...
HRESULT CTable::Ready_Component()
{
    // 버퍼
    ...
    // 텍스쳐
    if (FAILED((AddComponent<Engine::CTexture, ID_STATIC>(L"Proto_TableTex", L"Com_Texture", &m_pTextureCom))))
        return E_FAIL;
...
CTable* CTable::Create()
{
    CTable* pBackGround = new CTable;
