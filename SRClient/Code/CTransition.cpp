...
HRESULT CTransition::Transition_INIT_TO_LOGO()
{
	...
	CAssetMgr::GetInstance()->AddAsset(L"GLB_File1", CAssetGlb::Create(L"../Bin/Resource/Glb/Terrian1.glb"));
	CAssetMgr::GetInstance()->LoadAsset(L"GLB_File1");
	...
	CProtoMgr::GetInstance()->Ready_Prototype(L"GLB_File1",CGlbTex::Create(
		CAssetMgr::GetInstance()->Get_AssetFirst<CAssetGlb>(L"GLB_File1")->Get_VtxCnt(),
		CAssetMgr::GetInstance()->Get_AssetFirst<CAssetGlb>(L"GLB_File1")->Get_TriCnt(),
		CAssetMgr::GetInstance()->Get_AssetFirst<CAssetGlb>(L"GLB_File1")->Get_vertices(),
		CAssetMgr::GetInstance()->Get_AssetFirst<CAssetGlb>(L"GLB_File1")->Get_Index()));
