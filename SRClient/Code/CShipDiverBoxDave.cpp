...
CShipDiverBoxDave::CShipDiverBoxDave()
    : CGameObject()
{
}
...
HRESULT CShipDiverBoxDave::Ready_GameObject()
{
...
_int CShipDiverBoxDave::Update_GameObject(const _float& fTimeDelta)
{
...
void CShipDiverBoxDave::LateUpdate_GameObject(const _float& fTimeDelta)
{
    CGameObject::LateUpdate_GameObject(fTimeDelta);

}

void CShipDiverBoxDave::Render_GameObject()
{
...
HRESULT CShipDiverBoxDave::Ready_Component()
{
    // 버퍼
...
CShipDiverBoxDave* CShipDiverBoxDave::Create()
{
    CShipDiverBoxDave* pShipDave = new CShipDiverBoxDave;
