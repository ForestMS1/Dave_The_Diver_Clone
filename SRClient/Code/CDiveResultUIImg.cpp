...
CDiveResultUIImg::CDiveResultUIImg(float fPosX, float fPosY)
    : CGameObject()
    , m_fPosX(fPosX)
    , m_fPosY(fPosY)
    , m_sAssetName({})
...
CDiveResultUIImg::~CDiveResultUIImg()
{
}


HRESULT		CDiveResultUIImg::Ready_GameObject()
{
...
_int		CDiveResultUIImg::Update_GameObject(const _float& fTimeDelta)
{
...
void CDiveResultUIImg::Update_ImGui()
{
...
void		CDiveResultUIImg::LateUpdate_GameObject(const _float& fTimeDelta)
{
    CGameObject::LateUpdate_GameObject(fTimeDelta);
}

void		CDiveResultUIImg::Render_GameObject()
{
...
void CDiveResultUIImg::Ready_After_Create()
{
    if (!m_sAssetName.empty())
    {
        _vec3 vScale = { 1.f , 1.f, 1.f };
...
HRESULT			CDiveResultUIImg::Ready_Component()
{
    // 버퍼
...
CDiveResultUIImg* CDiveResultUIImg::Create(float fPosX, float fPosY)
{
    CDiveResultUIImg* pStar = new CDiveResultUIImg{ fPosX , fPosY };
