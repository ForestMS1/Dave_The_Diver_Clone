...
HRESULT CSushiLight::Ready_Component()
{
    ...
    // 텍스쳐
    if (FAILED((AddComponent<Engine::CTexture, ID_STATIC>(L"Proto_LightTex", L"Com_Texture", &m_pTextureCom))))
        return E_FAIL;
    ...
    //m_pTransformCom->m_vScale = { 12.5f, 6.f, 1.f };
    //m_pTransformCom->m_vInfo[INFO_POS] = { 0.f, 1.f, 2.f };
    return S_OK;
}
