...
CShipPhoneWeaponImg::CShipPhoneWeaponImg(float fPosX, float fPosY)
    : CGameObject()
    , m_fPosX(fPosX)
    , m_fPosY(fPosY)
    , m_sAssetName({})
...
CShipPhoneWeaponImg::~CShipPhoneWeaponImg()
{
}


HRESULT		CShipPhoneWeaponImg::Ready_GameObject()
{
...
void CShipPhoneWeaponImg::Ready_AfterCreate()
{
    _vec3 vScale = { 0.f , 0.f, 0.f };
    if (auto vecAsset = CAssetMgr::GetInstance()->Get_Asset(m_sAssetName))
    {
...
_int		CShipPhoneWeaponImg::Update_GameObject(const _float& fTimeDelta)
{
...
void		CShipPhoneWeaponImg::LateUpdate_GameObject(const _float& fTimeDelta)
{
    CGameObject::LateUpdate_GameObject(fTimeDelta);
}

void		CShipPhoneWeaponImg::Render_GameObject()
{
...
HRESULT			CShipPhoneWeaponImg::Ready_Component()
{
    // 버퍼
...
CShipPhoneWeaponImg* CShipPhoneWeaponImg::Create(float fPosX, float fPosY)
{
    CShipPhoneWeaponImg* pWeaponImg = new CShipPhoneWeaponImg{ fPosX , fPosY };
