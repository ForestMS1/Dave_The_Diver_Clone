...
#include "CAABB.h"
class CShipPhoneWeaponImg : public CGameObject
{
private:
	explicit CShipPhoneWeaponImg(float fPosX, float fPosY);
	virtual ~CShipPhoneWeaponImg();
...
public:
	static CShipPhoneWeaponImg* Create(float fPosX, float fPosY);
