...
class CHoldFishUIImg : public CGameObject
{
private:
	explicit CHoldFishUIImg(float fPosX, float fPosY);
	virtual ~CHoldFishUIImg();
...
public:
	static CHoldFishUIImg* Create(float fPosX, float fPosY);
